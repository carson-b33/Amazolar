...
const teamMembers = [
  { initials: 'DA', name: 'Danny Andrade', role: 'Co-Founder, Ecuador Operations Lead' },
  { initials: 'C', name: 'Carson', role: 'Co-Founder, Donor Relations & Strategy' },
...
document.querySelectorAll('[data-team-grid]').forEach((grid) => {
  grid.innerHTML = teamMembers.map((member) => `
    <article class="team-card">
      <div class="team-avatar"${member.image ? '' : ' aria-hidden="true"'}>${member.image
